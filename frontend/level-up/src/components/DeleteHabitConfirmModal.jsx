...
export default function DeleteHabitConfirmModal({ habitName, onConfirm, onCancel, visible }) {
        ...
        <div className="p-6">
          ...
          <div className="bg-white/60 rounded-xl p-4 mb-4 border border-red-200">
            <p className="text-gray-800 text-center mb-2">
              <span className="font-semibold text-red-700">"{habitName}"</span>
            </p>
            <p className="text-sm text-gray-700 text-center leading-relaxed">
              Tu veux vraiment supprimer définitivement cette habitude ? 😢
            </p>
